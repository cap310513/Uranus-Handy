"""
Eigene Kopie der freetype-Bauregel von python-for-android - identisch bis auf
die Download-Adresse.

download.savannah.gnu.org (die eingebaute Standard-Adresse) ist beim Bauen
mehrfach hintereinander mit HTTP 502/504 ausgefallen (auch mit mehreren
automatischen Wiederholungen im Workflow). SourceForge ist die urspruengliche,
offizielle Freetype-Ausgabestelle (steht auch so in der Original-Bauregel
vermerkt) und war beim Testen zuverlaessig erreichbar.
"""
...
class FreetypeRecipe(Recipe):
    version = "2.14.1"
    # Bewusst 'downloads.sourceforge.net' (nicht '.../download' am Ende):
    # diese Form endet im Pfad direkt auf den echten Dateinamen - p4a
    # bestimmt den lokalen Dateinamen per basename() der URL, ein '/download'
    # am Ende wuerde faelschlich zu einer Datei namens "download" fuehren.
